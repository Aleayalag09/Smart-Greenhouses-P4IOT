    ...
    def POST(self, *path, **queries):
        ...
        if strategyType == "irrigation":
            try:
                ...
                newStrategy_topic = "IoT_project_29_test1/"+str(db["userID"])+"/"+str(db["greenHouseID"])+"/irrigation/"+str(strategyID)
            ...
            newStrategy_topic_temp = "IoT_project_29_test1/"+str(db["userID"])+"/"+str(db["greenHouseID"])+"/environment/temperature"
            newStrategy_topic_hum = "IoT_project_29_test1/"+str(db["userID"])+"/"+str(db["greenHouseID"])+"/environment/humidity"
            # Subscribe to the MQTT topics
            ...
            newStrategy_topic = "IoT_project_29_test1/"+str(db["userID"])+"/"+str(db["greenHouseID"])+"/"+strategyType
            # Subscribe to the MQTT topics
            mqtt_handler.subscribe(newStrategy_topic)
...
class MQTT_subscriber_publisher(object):
    ...
    def on_message(self, client, userdata, message):
        ...
        if actuatorType == "weather":
            if value == "open":
                ...
                mqtt_handler.publish("IoT_project_29_test1/"+str(db["userID"])+"/"+str(db["greenHouseID"])+"/sensors/"+actuatorType, 1, actuatorType)
                ...
                mqtt_handler.publish("IoT_project_29_test1/"+str(db["userID"])+"/"+str(db["greenHouseID"])+"/sensors/"+actuatorType, 0, actuatorType)
            else:
                print("Invalid Value")
            ...
            if isinstance(value, (float, int)):
                ...
                mqtt_handler.publish("IoT_project_29_test1/"+str(db["userID"])+"/"+str(db["greenHouseID"])+"/sensors/"+actuatorType, value, actuatorType)  
            else:
                print("Invalid Value")
        ...
        mqtt_handler.publish("IoT_project_29_test1/"+str(db["userID"])+"/"+str(db["greenHouseID"])+"/utility/"+actuatorType, value, "utility")
    ...
    def publishSensorMeasure(self, measureType):
        ...
        topic = "IoT_project_29_test1/"+str(db["userID"])+"/"+str(db["greenHouseID"])+"/sensors/"+measureType
...
def getTopics():
    ...
    if irr_strat["strat"] != []:
        for strat in irr_strat["strat"]:
            topic = "IoT_project_29_test1/"+str(db["userID"])+"/"+str(db["greenHouseID"])+"/irrigation/"+str(strat["id"])
            db["strategies"]["irrigation"].append(topic)
            mqtt_handler.subscribe(topic)

    if env_strat["strat"] != []:
        topic_temp = "IoT_project_29_test1/"+str(db["userID"])+"/"+str(db["greenHouseID"])+"/environment/temperature"
        topic_hum = "IoT_project_29_test1/"+str(db["userID"])+"/"+str(db["greenHouseID"])+"/environment/humidity"
    ...
    if wea_strat["strat"] != []:
        topic = "IoT_project_29_test1/"+str(db["userID"])+"/"+str(db["greenHouseID"])+"/weather"
