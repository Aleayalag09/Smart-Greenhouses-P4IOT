...
class regTopic(object):
    ...
    def POST(self, *path, **queries):
        ...
        #     topic = "IoT_project_29_test1/"+str(userID)+"/"+str(greenHouseID)+"/sensors/"+sensorType
        #     new_topic = {
        #         "topic": topic
        #     }
        ...
        # topic = "IoT_project_29_test1/"+str(userID)+"/"+str(greenHouseID)+"/irrigation/#"
        # new_topic = {
        #     "topic": topic
        # }
        # db["topics"].append(new_topic)   
        ...
        topic = "IoT_project_29_test1/"+str(userID)+"/"+str(greenHouseID)+"/sensors/#"
        new_topic = {
            "topic": topic
        }
        db["topics"].append(new_topic)   
